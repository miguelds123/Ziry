...
function TableMaterialToolbar(props) {
  ...
  const update = () => {
    return navigate(`/updateCupones/${idSelected}`)
  }
  return (
    <Toolbar
      sx={{
...
export default function TableCupones() {
                    ...
                    .map((row, index) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <TableCell align='left'>{row.fecha_inicio}</TableCell>
                          <TableCell align='left'>{row.fecha_final}</TableCell>
                          <TableCell align='left'>{row.tipo_cupon}</TableCell>
